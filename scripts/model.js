/**
 * backbone model definitions for Hello Phreeze
 */
...
/**
 * Favorite Backbone Model
 */
model.FavoriteModel = Backbone.Model.extend({
...
/**
 * Favorite Backbone Collection
 */
model.FavoriteCollection = model.AbstractCollection.extend({
	url: 'api/favorites',
