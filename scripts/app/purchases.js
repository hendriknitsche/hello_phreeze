...
var page = {
	...
	renderModelView: function(showDeleteButton)	{
		...
		$('#favoritePurchaseButton').click(function(e) {
			e.preventDefault();
			$('#confirmFavoritePurchaseContainer').show('fast');
		});

		$('#cancelFavoritePurchaseButton').click(function(e) {
			e.preventDefault();
			$('#confirmFavoritePurchaseContainer').hide('fast');
		});

		$('#confirmFavoritePurchaseButton').click(function(e) {
			e.preventDefault();
			page.favoriteModel();
		});
	},
	...
	favoriteModel: function()	{
		...
		var fav = new model.FavoriteCollection();
		...
		$.post( "api/favorite/add/" + id, function( data ) {
			if(data != '')
			{
				console.log(data);
			}
