...
require_once("DAO/FavoriteCriteriaDAO.php");

/**
 * The FavoriteCriteria class extends FavoriteDAOCriteria and is used
 ...
 * @version 1.0
 */
class FavoriteCriteria extends FavoriteCriteriaDAO
{
