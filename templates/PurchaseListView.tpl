...
{block name=title}Hello Phreeze | Purchases{/block}
...
{block name=content}
	...
	<script type="text/template" id="purchaseModelTemplate">
		...
		<form id="favoritePurchaseButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					<label class="control-label"></label>
					<div class="controls">
						<button id="favoritePurchaseButton" class="btn btn-mini btn-info"><i class="icon-star icon-white"></i> Favorite Purchase</button>
						<span id="confirmFavoritePurchaseContainer" class="hide">
							<button id="cancelFavoritePurchaseButton" class="btn btn-mini">Cancel</button>
							<button id="confirmFavoritePurchaseButton" class="btn btn-mini btn-success">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
